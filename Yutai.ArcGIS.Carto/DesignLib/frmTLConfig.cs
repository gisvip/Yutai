...
{
    public partial class frmTLConfig : UserControl, IPropertyPage, IPropertyPageEvents
    {
        ...
        public void Apply()
        {
            ...
            ElementWizardHelp.LegendInfo = document.InnerXml;
        }
        ...
        private void frmTLConfig_Load(object sender, EventArgs e)
        {
            ...
            if (ElementWizardHelp.LegendInfo != "")
            {
                XmlDocument document = new XmlDocument();
                document.LoadXml(ElementWizardHelp.LegendInfo);
                XmlElement documentElement = document.DocumentElement;
                this.method_9(documentElement);
            }
            this.bool_0 = true;
