    ...
    public partial class FormPrinterSetupEx : Form
    {
        ...
        private void cboPageSize_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this.bool_0)
            {
                if (this.ipageLayoutControl_0.Page.FormID != esriPageFormID.esriPageFormSameAsPrinter)
                {
                    ...
                    num = this.method_9(this.ipageLayoutControl_0.Page.Units, num);
                    num2 = this.method_9(this.ipageLayoutControl_0.Page.Units, num2);
                    this.bool_0 = false;
        ...
        private void cboPrinterPageSize_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this.bool_0)
            {
                ...
                if (this.checkBox_usePrinterPageSize.Checked)
                {
                    ...
                    num = this.method_9(this.ipageLayoutControl_0.Printer.Units, num);
                    num2 = this.method_9(this.ipageLayoutControl_0.Printer.Units, num2);
                    this.bool_0 = false;
                    this.txtPageWidth.Text = num.ToString("0.#");
                    this.txtPageHeight.Text = num2.ToString("0.#");
                    this.bool_0 = true;
                    num = this.method_10(num, this.ipageLayoutControl_0.Page.Units);
                    num2 = this.method_10(num2, this.ipageLayoutControl_0.Page.Units);
        ...
        private void checkBox_usePrinterPageSize_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.ipageLayoutControl_0.Printer.Paper.QueryPaperSize(out num, out num2);
                num = this.method_9(this.ipageLayoutControl_0.Printer.Paper.Units, num);
                num2 = this.method_9(this.ipageLayoutControl_0.Printer.Paper.Units, num2);
                num = this.method_10(num, this.ipageLayoutControl_0.Page.Units);
                num2 = this.method_10(num2, this.ipageLayoutControl_0.Page.Units);
                this.ipageLayoutControl_0.Page.PutCustomSize(num, num2);
        ...
        private void method_0(IMap imap_0, IEnvelope ienvelope_0)
        {
            try
            {
                IActiveView view = (IActiveView) imap_0;
                view.ScreenDisplay.DisplayTransformation.VisibleBounds = ienvelope_0;
            }
        ...
        private double method_10(double double_0, esriUnits esriUnits_0)
        {
            switch (esriUnits_0)
            {
        ...
        private void method_6()
        {
            ...
            {
                this.cboPrinterPageSize.Items.Add(new Class9(str, num));
            }
            ...
            while (str != null)
            {
                this.cboPaperTrays.Items.Add(new Class10(str, num));
            ...
            if (this.checkBox_usePrinterPageSize.Checked)
            {
                ...
                num3 = this.method_9(this.ipageLayoutControl_0.Printer.Units, num3);
                num4 = this.method_9(this.ipageLayoutControl_0.Printer.Units, num4);
            ...
            else
            {
                ...
                num3 = this.method_9(this.ipageLayoutControl_0.Page.Units, num3);
                num4 = this.method_9(this.ipageLayoutControl_0.Page.Units, num4);
            }
            this.bool_0 = false;
        ...
        {
            if (!this.method_8(this.textBox_copied.Text))
            {
                this.textBox_copied.Text = this.printDialog_0.PrinterSettings.Copies.ToString();
            }
            else
        ...
        {
            if (!this.method_7(this.txbOverlap.Text))
            {
        ...
        {
            if (!this.method_8(this.txbStartPage.Text))
            {
                this.txbStartPage.Text = "1";
            }
        }
        ...
        private partial class Class9
        {
            private string string_0;
            private int int_0;

            public Class9(string string_1, int int_1)
            {
                this.string_0 = string_1;
                this.int_0 = int_1;
            }
