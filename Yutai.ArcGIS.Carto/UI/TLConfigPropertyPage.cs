...
namespace Yutai.ArcGIS.Carto.UI
{
    public partial class TLConfigPropertyPage : UserControl, IPropertyPage, IPropertyPageEvents
    {
        ...
        public void Apply()
        {
            ...
            this.icustomLegend_0.LegendInfo = document.InnerXml;
        }
        ...
        {
            this.icustomLegend_0 = object_0 as ICustomLegend;
        }

        private void TLConfigPropertyPage_Load(object sender, EventArgs e)
        {
            this.renderInfoListView1.SetColumnEditable(1, true);
            if (this.icustomLegend_0.LegendInfo != "")
            {
                XmlDocument document = new XmlDocument();
                document.LoadXml(this.icustomLegend_0.LegendInfo);
                XmlElement documentElement = document.DocumentElement;
                this.method_9(documentElement);
            }
            this.bool_0 = true;
