...
namespace Yutai.Plugins.Catalog.Menu
{
    internal class MenuGenerator
    {
        ...
        private readonly CatalogPlugin _plugin;


        public MenuGenerator(IAppContext context, CatalogPlugin plugin)
        {
        ...
        private void InitMenus()
        {
            ...
            Guid dllGuid = new Guid("5e857d4e-1a77-46d8-b1bb-b36548be7333");
            string resString = "Yutai.Plugins.Catalog.Menu.MenuLayout.xml";
            XmlPlugin plugin =
