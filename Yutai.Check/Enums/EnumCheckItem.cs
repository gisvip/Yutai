...
namespace Yutai.Check.Enums
{
    public enum EnumCheckItem
    {
        ...
        P_Standardization,  // 属性检查 字段标准化检查。
        P_MaxLength,        // 属性检查 管线最大长度检查 检查管线最大长度是否超过预设值。
        P_Depth,            // 属性检查 地下埋深取值检查 检查地下埋深取值是否在范围内。
        ...
        G_MinimumSpacing,   // 空间检查 最小间距检查 检查管点/管线的最小间距是否小于预设值。
