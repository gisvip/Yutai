            ...
            using (SaveFileDialog saveDialog = new SaveFileDialog())
            {
                ...
                if (saveDialog.ShowDialog() != DialogResult.Cancel)
                {
                    ...
                    if (File.Exists(exportFilePath))
                    {
                        ...
                        {
                            String msg = "The file could not be opened." + Environment.NewLine + Environment.NewLine +
                                         "Path: " + exportFilePath;
                    ...
                    {
                        String msg = "The file could not be saved." + Environment.NewLine + Environment.NewLine +
                                     "Path: " + exportFilePath;
                        MessageBox.Show(msg, "Error!", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
