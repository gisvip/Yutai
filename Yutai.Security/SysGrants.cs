    ...
    public class SysGrants
    {
        ...
        public bool GetStaffAndRolesPlugePri(int int_0, string string_3)
        {
            ...
            else if ((this.string_1 == "admin" ? false : this.string_1.Length != 0))
            {
                ...
                {
                    CErrorLog.writeErrorLog(null, exception, str);
                    count = false;
                }
            }
            else
        ...
        public bool IsStaffHasMapsPri(string string_3, int int_0, int int_1)
        {
            ...
            if (this.dataProviderType_0 != DataProviderType.None)
            {
                ...
                if (int_0 != 2)
                {
                    if (int_0 == 1)
                    {
                        string3 = new string[] { "Grantee='", string_3, "' and GRANTEETYPE='Staff' and ObjectType='gisMap'  and  GRANTOBJECT = '", int_1.ToString(), "'" };
                        str = string.Concat(string3);
                    }
                    flag = false;
                    return flag;
                ...
                {
                    string3 = new string[] { "Grantee='", string_3, "' and GRANTEETYPE='Staff' and  ObjectType='gisMap' and privilegeFlag='2'  and  GRANTOBJECT = '", int_1.ToString(), "'" };
                    str = string.Concat(string3);
                }
