...
{
    class CmdCreateLineWithToPoint : YutaiTool
    {
        ...
        public CmdCreateLineWithToPoint(IAppContext context, PipelineEditorPlugin plugin)
        {
            OnCreate(context);
            _plugin = plugin;
        }
        ...
        public sealed override void OnCreate(object hook)
        {
            ...
            base.m_caption = "新建管线(包含终点)";
            base.m_category = "PipelineEditor";
            base.m_bitmap = Properties.Resources.icon_CreateLineWithToPoint;
            this.m_cursor = new System.Windows.Forms.Cursor(new MemoryStream(Resources.Digitise));
            base.m_name = "PipelineEditor_CreateLineWithToPoint";
            base._key = "PipelineEditor_CreateLineWithToPoint";
            base.m_toolTip = "新建管线数据，包含终点";
            base.m_checked = false;
            base.m_message = "新建管线数据，包含终点";
        ...
        public override void OnDblClick()
        {
            try
            {
                ...
                if (polyline == null)
                    return;
                CommonHelper.CreatePointFeatures(_pointFeatureLayer, polyline, false, true, true);
